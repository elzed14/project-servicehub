  ...
  return (
    <Link to={`/expert/${expert.id}`}>
      <motion.div
        ...
        whileTap={{ scale: 0.98 }}
        className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100 overflow-hidden h-full flex flex-col"
      >
        {/* En-tête avec avatar */}
      ...
      <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 mt-auto">
        <div className="flex items-center justify-between">
          ...
          <Link to={`/messages?expertId=${expert.id}`} onClick={(e) => e.stopPropagation()}>
            <motion.button
